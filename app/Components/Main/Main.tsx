...
const Main = () => {
    ...
    return (
        <main className={`flex flex-col`}>
            ...
            <p className="mx-4 mt-4 text-xl uppercase font-medium tracking-wide pb-8  font-playfairDisplay text-justify">Book from an array of exhilarating activities and courses, great for families. the best choice for relaxing, learning, and exploring.</p>
            <div className={'flex items-center z-20 mb-4'}>
                <ul className="flex gap-8 lg:gap-16 items-center ml-2 z-20">
                    <li>
                ...
                <span className="text-2xl font-[800] italic font-playfairDisplay lg:mb-4 lg:text-4xl lg:bg-black lg:text-white mr-2 backdrop-blur-sm lg:pl-4 lg:py-2 lg:pr-8">Follow Us</span>
            </div>
        </main>
    )
}
