    ...
    return (
        <div className="mx-4 flex flex-col shadow-xl border">
            <div className="bg-white flex flex-col justify-center items-center gap-8 py-8">
                <span className="text-xl font-extrabold tracking-wider uppercase">{data.title}</span>
                <span className="text-4xl font-playfairDisplay font-[600]">{`£${data.price}`}</span>
                <button className=" bg-black text-white shadow-xl rounded-md leading-6 py-3 px-16 font-light text-2xl tracking-wider w-fit">Book Now</button>
            </div>
