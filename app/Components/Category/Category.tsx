    ...
    return (
        <li ref={categoryRef} className={`${active && 'pointer-events-none'} bg-white relative lg:pointer-events-none lg:border-b-2 lg:border-black overscroll-contain select-none`} onClick={() => handleSelected()}>
            ...
            ${categoryClicked !== title && categoryClicked !== '' ? 'opacity-50 duration-200' : 'opacity-100 duration-500'} lg:grid overscroll-contain select-none lg:pt-4 grid-cols-[2fr,1fr] auto-rows-min`}>
                {/* Image/Gallery */}
                <div className={`${active ? "pointer-events-auto" : 'pointer-events-none'} w-[100%] lg:w-full aspect-[3/2] lg:aspect-auto lg:h-[100%] mx-auto relative mb-4`} onClick={() => handleExit()}>
