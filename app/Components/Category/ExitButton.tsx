...
const ExitButton = ({active}: ExitButtonProps) => {
    return (
        <button className={`bg-black ${active ? "opacity-100 pointer-events-auto  duration-300" : "opacity-0 pointer-events-none"} p-2 rounded-full fixed bottom-0 right-0 m-4 z-40`}>
